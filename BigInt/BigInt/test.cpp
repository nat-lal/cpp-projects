...
int main(int argc, char *argv[]) {
  if (argc < 3) {
    ...
    cout << "<mode>\t0: compare, 1: convertToInt, 2: Int10ToOtherBase 3: add,"
         << endl;
    ...
    cout << "\t./test 16 1 \033[1;90m//base 16, run convertToInt\033[0m"
         << endl;
  ...
  ifstream ifile(file);
  if (ifile.fail()) {
    cout << "\033[1;31mError:\033[0m Incorrect base input (" << test_base << ")"
         << endl;
    return -1;
  }
  int base;
      ...
      if (mode > 2) {
        if (mode == 9) {
          ...
          if (actual_result.to_string() != expected_result) {
            cout << "\033[1;31m" << cross << " Failed: \033[0m(" << a << " ^ "
                 << b << ") % " << m << " | "
                 << "Expected: " << expected_result
                 << ", Actual: " << actual_result.to_string() << endl;
            failed += 1;
          } else {
            cout << "\033[1;32m" << check << " Passed: \033[0m(" << a << " ^ "
                 << b << ") % " << m << endl;
            passed += 1;
          }
        } else {
        ...
        if (mode == 0) {
          ...
          if (to_string(compareResult) != expected_result) {
            cout << "\033[1;31m" << cross << " Failed: \033[0m" << a << " and "
                 << b << " | "
                 << "Expected: " << expected_result
                 << ", Actual: " << compareResult << endl;
            failed += 1;
          } else {
            cout << "\033[1;32m" << check << " Passed: \033[0m" << a << " and "
                 << b << endl;
            passed += 1;
          }
        } else if (mode == 1) {
          ...
          if (to_string(intresult) != expected_result) {
            cout << "\033[1;31m" << cross << " Failed: \033[0m" << a << " | "
                 << "Expected: " << expected_result << ", Actual: " << intresult
                 << endl;
            failed += 1;
          } else {
  ...
  // Print Summary
  cout << "=======================================" << endl;
  cout << testnum << " \033[1;36m" << type
       << "\033[0m tests for base \033[1;36m" << base << "\033[0m (";
  if (failed != 0) {
    cout << "\033[1;31m" << failed << " failed\033[0m, " << passed << " passed)"
         << endl;
  } else {
    cout << failed << " failed, \033[1;32m" << passed << " passed\033[0m)"
         << endl;
  }
  return 0;
}
